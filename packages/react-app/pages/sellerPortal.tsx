...
const SellerPortal: React.FC = () =>{
    ...
    return (
        ...
        <div className="w-full text-center bg-white border border-black-200 rounded-lg shadow sm:p-8 dark:bg-transparent dark:border-orange-600 p-5">
            <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-orange-600">Manage Products</h5>
            <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-zinc-950">Stay up to date and move work forward with Flowbite on iOS & Android. Download the app today.</p>
