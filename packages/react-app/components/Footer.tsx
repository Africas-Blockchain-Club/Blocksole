...
export default function Footer() {
  ...
  return (
    <footer className="bg-gypsum flex mt-auto mb-4 border-black border-t rounded-lg shadow-lg fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-screen-xl mx-2 lg:mx-8 h-16 items-center">
